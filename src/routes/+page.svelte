              ...
              <div class="container mx-auto p-6  text-white even:image-order-even w-full">
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                      ...
                      <a class="mt-12 button button-brand w-full" use:scrollTo={{section: "contact"}} href="/">Get In Touch</a>
                    </div>
                    <div class="flex justify-center items-center">
                      <img src="/img/jeep.webp" alt="Service Image" class="rounded-lg shadow-xl">
                    </div>
                  </div>
                  <div class="mt-12">
